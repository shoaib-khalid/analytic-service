...
public class GenerateSummaryBulk {
    ...
    public void generateSummary() throws Exception {
        if (isEnabled) {
            ...
            dateList[0]="2022-06-20";
            dateList[1]="2022-06-21";
            dateList[2]="2022-06-22";
            dateList[3]="2022-06-23";
            ...
            for (int x=0;x<dateList.length;x++) {
                ...
                for (int i=0;i<userList.size();i++) {
                    ...
                    try {
                        if (totalRecord==0) {
                            Logger.application.info(Logger.pattern, AnalyticServiceApplication.VERSION, logprefix, "Create new record for date:"+dt+" storeId:"+storeId+" totalUnique:"+totalUnique);
